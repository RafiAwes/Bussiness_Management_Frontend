...
export const InvoiceList: React.FC<{ minimal?: boolean, onCreateInvoice?: () => void }> = ({ minimal, onCreateInvoice }) => {
  const content = (
    <>
      {!minimal && (
      ...
      <div className="card-premium overflow-hidden">
        <div className="p-6 border-b border-slate-50 flex items-center justify-between bg-white">
          <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest italic">Awaiting Invoices</h3>
          <span className="text-[10px] font-black text-rose-500 uppercase tracking-widest">Pending Sync</span>
        </div>
